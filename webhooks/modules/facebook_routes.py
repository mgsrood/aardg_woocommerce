from modules.facebook_functions import add_new_customers_to_facebook_audience
...
def facebook_audience_customer_adder(greit_connection_string, klant, bron, wcapi, secret_key, long_term_token, custom_audience_id, ad_account_id, app_secret, app_id):
    ...
    # Route configuratie
    route_naam = "Nieuwe klanten toevoegen aan Facebook Audience"
    ...
    if 'id' in data:
        ...
        if response.status_code == 200:
            ...
            log(greit_connection_string, klant, bron, f"Klant {customer_data['billing']['first_name'] + ' ' + customer_data['billing']['last_name']} verwerkt", route_naam, script_id, tabel=None)
