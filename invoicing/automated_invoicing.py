...
import io
import os
from order_list import order_ids
...
def send_email_with_attachment(all_invoices, customer_email, order_details):
    # Configure the email
    ...
    Zie bijgevoegd de factuur of facturen van Aard'g van afgelopen maand.
...
send_email_with_attachment(all_invoices, customer_email, order_details)